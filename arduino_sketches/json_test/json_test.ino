...
void demoCreation() {
  ...
  myObject["soilMoisture"] = jsonString;


  JSONVar myArray_light;
  
  myArray_light[0] = 470;
  myArray_light[1] = 900;

  Serial.print("myArray_light.length() = ");
  Serial.println(myArray_light.length());

  // JSON.stringify(myVar) can be used to convert the json var to a String
  String jsonString_light = JSON.stringify(myArray_light);

  Serial.print("JSON.stringify(myArray_light) = ");
  Serial.println(jsonString_light);
  myObject["lightThreshold"] = jsonString_light;
  ...
  // JSON.stringify(myVar) can be used to convert the json var to a String
  String jsonString_1 = JSON.stringify(myObject);
